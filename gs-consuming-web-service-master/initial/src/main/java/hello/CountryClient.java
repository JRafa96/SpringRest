...
public class CountryClient extends WebServiceGatewaySupport {
	...
	public ExistsCountryResponse existsCountry(String country) {
		...
		ExistsCountryResponse response = (ExistsCountryResponse) getWebServiceTemplate()
				.marshalSendAndReceive("http://localhost:8080/ws/existsCountry", request,
						new SoapActionCallback(
								"http://spring.io/guides/gs-producing-web-service/existsCountryRequest"));
